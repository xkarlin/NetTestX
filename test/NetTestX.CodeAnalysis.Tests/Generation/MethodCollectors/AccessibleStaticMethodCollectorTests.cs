...
public class AccessibleStaticMethodCollectorTests
{
    [Fact]
...
""");
        ...
        AccessibleStaticMethodCollector sut = new();
...
""");
        ...
        Assert.IsType<AccessibleStaticMethodBodyModel>(result.MethodBodyModel);
    }
}
